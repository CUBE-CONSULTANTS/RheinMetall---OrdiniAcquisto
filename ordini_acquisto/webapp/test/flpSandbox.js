		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ordiniacquistoordiniacquisto-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ordiniacquistoordiniacquisto-display": {
								"semanticObject": "ordiniacquistoordiniacquisto",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ordiniacquisto.ordiniacquisto",
									"url": sap.ui.require.toUrl("ordiniacquisto/ordiniacquisto")
								}
							}
						}
					}
